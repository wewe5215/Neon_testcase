...
void f1(){
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec_s16) / sizeof(test_vec_s16[0])) ; i++) {
        ...
        print_int8x16(vrshrn_high_n_s16(r, a, 1));
        print_int8x16(vrshrn_high_n_s16(r, a, 3));
        print_int8x16(vrshrn_high_n_s16(r, a, 5));
        print_int8x16(vrshrn_high_n_s16(r, a, 6));
        print_int8x16(vrshrn_high_n_s16(r, a, 8));
    }
...
void f2(){
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec_s32) / sizeof(test_vec_s32[0])) ; i++) {
        ...
        print_int16x8(vrshrn_high_n_s32(r, a, 3));
        print_int16x8(vrshrn_high_n_s32(r, a, 6));
        print_int16x8(vrshrn_high_n_s32(r, a, 10));
        print_int16x8(vrshrn_high_n_s32(r, a, 13));
        print_int16x8(vrshrn_high_n_s32(r, a, 16));
...
void f3(){
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec_s64) / sizeof(test_vec_s64[0])) ; i++) {
        ...
        print_int32x4(vrshrn_high_n_s64(r, a, 6));
        print_int32x4(vrshrn_high_n_s64(r, a, 13));
        print_int32x4(vrshrn_high_n_s64(r, a, 19));
        print_int32x4(vrshrn_high_n_s64(r, a, 26));
        print_int32x4(vrshrn_high_n_s64(r, a, 32));
    }
...
void f4(){
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec_u16) / sizeof(test_vec_u16[0])) ; i++) {
        ...
        print_uint8x16(vrshrn_high_n_u16(r, a, 1));
        print_uint8x16(vrshrn_high_n_u16(r, a, 3));
        print_uint8x16(vrshrn_high_n_u16(r, a, 5));
        print_uint8x16(vrshrn_high_n_u16(r, a, 6));
        print_uint8x16(vrshrn_high_n_u16(r, a, 8));
    }
...
void f5(){
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec_u32) / sizeof(test_vec_u32[0])) ; i++) {
        ...
        print_uint16x8(vrshrn_high_n_u32(r, a, 3));
        print_uint16x8(vrshrn_high_n_u32(r, a, 6));
        print_uint16x8(vrshrn_high_n_u32(r, a, 10));
        print_uint16x8(vrshrn_high_n_u32(r, a, 13));
        print_uint16x8(vrshrn_high_n_u32(r, a, 16));
    }
...
void f6(){
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec_u64) / sizeof(test_vec_u64[0])) ; i++) {
        ...
        print_uint32x4(vrshrn_high_n_u64(r, a, 6));
        print_uint32x4(vrshrn_high_n_u64(r, a, 13));
        print_uint32x4(vrshrn_high_n_u64(r, a, 19));
        print_uint32x4(vrshrn_high_n_u64(r, a, 26));
        print_uint32x4(vrshrn_high_n_u64(r, a, 32));
    }
