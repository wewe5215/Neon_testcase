...
void f1(){
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec_s16) / sizeof(test_vec_s16[0])) ; i++) {
        ...
        print_uint8x16(vqshrun_high_s16(r, a, 1));
        print_uint8x16(vqshrun_high_s16(r, a, 3));
        print_uint8x16(vqshrun_high_s16(r, a, 5));
        print_uint8x16(vqshrun_high_s16(r, a, 6));
        print_uint8x16(vqshrun_high_s16(r, a, 8));
    }
...
void f2(){
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec_s32) / sizeof(test_vec_s32[0])) ; i++) {
        ...
        print_uint16x8(vqshrun_high_s32(r, a, 3));
        print_uint16x8(vqshrun_high_s32(r, a, 6));
        print_uint16x8(vqshrun_high_s32(r, a, 10));
        print_uint16x8(vqshrun_high_s32(r, a, 13));
        print_uint16x8(vqshrun_high_s32(r, a, 16));
...
void f3(){
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec_s64) / sizeof(test_vec_s64[0])) ; i++) {
        ...
        print_uint32x4(vqshrun_high_s64(r, a, 6));
        print_uint32x4(vqshrun_high_s64(r, a, 13));
        print_uint32x4(vqshrun_high_s64(r, a, 19));
        print_uint32x4(vqshrun_high_s64(r, a, 26));
        print_uint32x4(vqshrun_high_s64(r, a, 32));
    }
